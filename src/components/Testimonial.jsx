...
function Testimonial() {
  useEffect(() => {
    // Inisialisasi KeenSlider setelah komponen dirender
    ...
    // Menambahkan event listener pada tombol prev dan next setelah elemen ada di DOM
    ...
    // Membersihkan event listeners saat komponen di-unmount
    return () => {
      if (keenSliderPrevious) {
